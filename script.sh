...
sed -i '1i src-git openwrt_passwall_packages https://github.com/Openwrt-Passwall/openwrt-passwall.git' feeds.conf.default
sed -i '1i src-git openwrt_passwall2_packages https://github.com/Openwrt-Passwall/openwrt-passwall2.git' feeds.conf.default
